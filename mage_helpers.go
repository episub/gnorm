...
func flags() (string, error) {
	...
	return fmt.Sprintf(`-X "github.com/episub/gnorm/cli.timestamp=%s" -X "github.com/episub/gnorm/cli.commitHash=%s" -X "github.com/episub/gnorm/cli.version=%s"`, timestamp, hash, version), nil
}
